...
export type BlockType = 'paragraph' | 'h1' | 'h2' | 'h3' | 'h4' | 'bullet' | 'numbered' | 'toggle' | 'todo' | 'code' | 'command' | 'quote' | 'math' | 'divider' | 'table' | 'image' | 'video' | 'audio' | 'file' | 'bookmark';
...
export type Snapshot = { id: string; label: string; payload: any; createdAt: number };
